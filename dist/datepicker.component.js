...
var DatePicker = /** @class */ (function () {
    ...
    DatePicker.prototype.writeValue = function (value) {
        if (value !== undefined && value !== null) {
            if (!this.settings.rangepicker) {
                ...
                if (this.dateRange.startDate.getMonth() ===
    ...
    DatePicker.prototype.initDateRange = function (val) {
        ...
        if (this.dateRange.startDate.getHours() == 0 ||
            this.dateRange.startDate.getHours() == 12) {
            this.hourValue = 12;
        }
        ...
        if (this.dateRange.endDate.getHours() == 0 ||
            this.dateRange.endDate.getHours() == 12) {
            this.toHourValue = 12;
        }
    ...
    DatePicker.prototype.generateDays = function (date) {
        ...
        for (var i = 0; i < 9; i++) {
            ...
            for (var j = 0; j <= 6; j++) {
                ...
                dateRow.push({
                    day: dateCell,
                    date: new Date(month + 1 + "-" + dateCell + "-" + date.getFullYear())
                });
            }
    ...
    DatePicker.prototype.setTimeView = function () {
        this.hourValue =
            parseInt(this.hourValue) > 12 ? 12 : parseInt(this.hourValue) || 12;
        this.minValue =
            parseInt(this.minValue) > 59 ? 59 : parseInt(this.minValue) || 59;
    ...
    DatePicker.prototype.setEndDate = function (selectedDate) {
        if (selectedDate > this.dateRange.startDate &&
            this.dateRange.startDate != this.dateRange.endDate) {
            this.dateRange.endDate = new Date(selectedDate);
        }
        else if (selectedDate > this.dateRange.startDate &&
            this.dateRange.startDate == this.dateRange.endDate) {
            this.dateRange.endDate = new Date(selectedDate);
        }
        else if (selectedDate < this.dateRange.startDate &&
